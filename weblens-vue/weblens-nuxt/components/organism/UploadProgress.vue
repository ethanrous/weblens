<template>
    <div
        ref="containerRef"
        :class="{
            'bg-background-primary goneable absolute top-16 right-2 z-50 flex flex-col items-center overflow-hidden rounded-b border border-t-0 shadow-md transition-[height,width,border-radius,opacity] duration-300 ease-out': true,
