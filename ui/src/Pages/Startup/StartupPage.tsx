...
export default function StartUp() {
    ...
    useEffect(() => {
        HandleWebsocketMessage(lastMessage, startupWebsocketHandler(setSetupProgress, setSetupMostRecent));
    }, [lastMessage]);

    return (
        <div className="flex flex-col justify-center items-center w-screen h-screen bg-background">
            <p className="startup-header-text text-wrap">Weblens is Starting...</p>
            {setupProgress !== 0 && (
