export default function Logo({ size = 40 }: { size?: number }) {
    return (
        <a href="https://github.com/ethanrous/weblens" target="_blank">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                version="1.1"
                viewBox="0 0 768.2 748"
