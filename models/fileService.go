...
// 	GetFileSafe(id fileTree.FileId, accessor *user_model.User, share *FileShare) (*fileTree.WeblensFileImpl, error)
//
// 	PathToFile(searchPath string) (*fileTree.WeblensFileImpl, error)
// 	UserPathToFile(searchPath string, user *user_model.User) (*fileTree.WeblensFileImpl, error)
//
...
//
// 	GetFileOwner(file *fileTree.WeblensFileImpl) (*user_model.User, error)
...
// 	MoveFilesToTrash(file []*fileTree.WeblensFileImpl, mover *user_model.User, share *FileShare, caster FileCaster) error
...
//
// 	NewZip(zipName string, owner *user_model.User) (*fileTree.WeblensFileImpl, error)
