...
func TestYoink(t *testing.T) {
	t.Run("removes element at index", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		result, yoinked := wlslices.Yoink(s, 2)
	...
	t.Run("removes first element", func(t *testing.T) {
		s := []string{"a", "b", "c"}
		result, yoinked := wlslices.Yoink(s, 0)
...
func TestAddToSet(t *testing.T) {
	t.Run("adds new elements", func(t *testing.T) {
		s := []int{1, 2, 3}
		result := wlslices.AddToSet(s, 4, 5)
		assert.Equal(t, []int{1, 2, 3, 4, 5}, result)
	})

	t.Run("does not add duplicates", func(t *testing.T) {
		s := []int{1, 2, 3}
		result := wlslices.AddToSet(s, 2, 3, 4)
	...
	t.Run("adds to empty slice", func(t *testing.T) {
		...
		result := wlslices.AddToSet(s, "a", "b")
		assert.Equal(t, []string{"a", "b"}, result)
	})

	t.Run("handles all duplicates", func(t *testing.T) {
		s := []int{1, 2, 3}
		result := wlslices.AddToSet(s, 1, 2, 3)
...
func TestInsertFunc(t *testing.T) {
	t.Run("inserts in sorted order", func(t *testing.T) {
		s := []int{1, 3, 5}
		result := wlslices.InsertFunc(s, 4, cmp.Compare)
		assert.Equal(t, []int{1, 3, 4, 5}, result)
	})

	t.Run("inserts at beginning", func(t *testing.T) {
		s := []int{2, 3, 4}
		result := wlslices.InsertFunc(s, 1, cmp.Compare)
		assert.Equal(t, []int{1, 2, 3, 4}, result)
	})
...
func TestContainsS(t *testing.T) {
	t.Run("finds element in sorted slice", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		assert.True(t, wlslices.ContainsS(s, 3))
	})
...
func TestMap(t *testing.T) {
	t.Run("transforms elements", func(t *testing.T) {
		s := []int{1, 2, 3}
		result := wlslices.Map(s, func(i int) int { return i * 2 })
		assert.Equal(t, []int{2, 4, 6}, result)
	})

	t.Run("changes type", func(t *testing.T) {
		s := []int{1, 2, 3}
		result := wlslices.Map(s, func(i int) string {
...
func TestMapI(t *testing.T) {
	t.Run("transforms with index", func(t *testing.T) {
		s := []string{"a", "b", "c"}
		result := wlslices.MapI(s, func(_ string, i int) int { return i })
		assert.Equal(t, []int{0, 1, 2}, result)
	})

	t.Run("uses both value and index", func(t *testing.T) {
		s := []int{10, 20, 30}
		result := wlslices.MapI(s, func(v int, i int) int { return v + i })
...
func TestSortFunc(t *testing.T) {
	t.Run("sorts in ascending order", func(t *testing.T) {
		...
		result := wlslices.SortFunc(s, cmp.Compare)
		assert.Equal(t, []int{1, 1, 2, 3, 4, 5, 6, 9}, result)
	})

	t.Run("sorts in descending order", func(t *testing.T) {
		s := []int{3, 1, 4}
		result := wlslices.SortFunc(s, func(a, b int) int { return cmp.Compare(b, a) })
...
func TestBinarySearchFunc(t *testing.T) {
	t.Run("finds element", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		idx, found := wlslices.BinarySearchFunc(s, 3, cmp.Compare)
		assert.True(t, found)
...
func TestBinarySearchIndexFunc(t *testing.T) {
	t.Run("returns insertion index", func(t *testing.T) {
		s := []int{1, 3, 5, 7}
		idx := wlslices.BinarySearchIndexFunc(s, 4, cmp.Compare)
		assert.Equal(t, 2, idx)
	})

	t.Run("returns 0 for smallest", func(t *testing.T) {
		s := []int{2, 3, 4}
		idx := wlslices.BinarySearchIndexFunc(s, 1, cmp.Compare)
...
func TestFilter(t *testing.T) {
	t.Run("filters even numbers", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5, 6}
		result := wlslices.Filter(s, func(i int) bool { return i%2 == 0 })
		assert.Equal(t, []int{2, 4, 6}, result)
	})
	...
	t.Run("handles empty slice", func(t *testing.T) {
		...
		result := wlslices.Filter(s, func(_ int) bool { return true })
		assert.Empty(t, result)
	})
}
...
func TestFilterMap(t *testing.T) {
	t.Run("filters and transforms", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		result := wlslices.FilterMap(s, func(i int) (string, bool) {
			if i%2 == 0 {
	...
	t.Run("filters all out", func(t *testing.T) {
		s := []int{1, 3, 5}
		result := wlslices.FilterMap(s, func(i int) (int, bool) {
			if i%2 == 0 {
				return i * 2, true
			}
...
func TestReduce(t *testing.T) {
	t.Run("sums numbers", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		result := wlslices.Reduce(s, func(v int, acc int) int { return acc + v }, 0)
		assert.Equal(t, 15, result)
	})

	t.Run("concatenates strings", func(t *testing.T) {
		s := []string{"a", "b", "c"}
		result := wlslices.Reduce(s, func(v string, acc string) string { return acc + v }, "")
	...
	t.Run("handles empty slice", func(t *testing.T) {
		...
		result := wlslices.Reduce(s, func(v int, acc int) int { return acc + v }, 10)
...
func TestConvert(t *testing.T) {
	...
	t.Run("handles empty slice", func(t *testing.T) {
		...
		result := wlslices.Convert[string](s)
		assert.Empty(t, result)
	})
}
...
func TestIndexFunc(t *testing.T) {
	t.Run("finds first match", func(t *testing.T) {
		s := []int{1, 2, 3, 4, 5}
		idx := wlslices.IndexFunc(s, func(i int) bool { return i > 3 })
		assert.Equal(t, 3, idx)
	})

	t.Run("returns -1 for no match", func(t *testing.T) {
		s := []int{1, 2, 3}
		idx := wlslices.IndexFunc(s, func(i int) bool { return i > 10 })
		assert.Equal(t, -1, idx)
	})
	...
	t.Run("handles empty slice", func(t *testing.T) {
		...
		idx := wlslices.IndexFunc(s, func(_ int) bool { return true })
		assert.Equal(t, -1, idx)
	})
}
