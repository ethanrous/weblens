    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "csv",
                        "description": "Media IDs to fetch",
                        "name": "mediaIDs",
                        "in": "query"
                    }
                ],
        ...
        "/tags/file/{fileID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Tags containing the file",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_ethanrous_weblens_models_tag.Tag"
        ...
        "/tags/{tagID}/files": {
            ...
            "delete": {
                ...
                "operationId": "RemoveFilesFromTag",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tag ID",
