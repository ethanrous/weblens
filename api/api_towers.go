...
func (r ApiEnableTraceLoggingRequest) Execute() (*http.Response, error) {
	return r.ApiService.EnableTraceLoggingExecute(r)
}
...
func (a *TowersAPIService) EnableTraceLoggingExecute(r ApiEnableTraceLoggingRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TowersAPIService.EnableTraceLogging")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tower/trace"
...
func (r ApiGetServerHealthStatusRequest) Execute() (*TowerHealth, *http.Response, error) {
	return r.ApiService.GetServerHealthStatusExecute(r)
}
...
func (a *TowersAPIService) GetServerHealthStatusExecute(r ApiGetServerHealthStatusRequest) (*TowerHealth, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TowerHealth
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TowersAPIService.GetServerHealthStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
