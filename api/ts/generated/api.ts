...
export const FilesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        searchFiles: async (search: string, baseFolderID?: string, sortProp?: SearchFilesSortPropEnum, sortOrder?: SearchFilesSortOrderEnum, recursive?: boolean, regex?: boolean, tags?: string, tagJoinLogic?: SearchFilesTagJoinLogicEnum, includeContent?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export class FilesApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public searchFiles(search: string, baseFolderID?: string, sortProp?: SearchFilesSortPropEnum, sortOrder?: SearchFilesSortOrderEnum, recursive?: boolean, regex?: boolean, tags?: string, tagJoinLogic?: SearchFilesTagJoinLogicEnum, includeContent?: boolean, options?: RawAxiosRequestConfig) {
...
export const MediaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        dropEmbeddings: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getMedia: async (shareID?: string, raw?: boolean, hidden?: boolean, sort?: GetMediaSortEnum, sortDirection?: GetMediaSortDirectionEnum, search?: string, page?: number, limit?: number, folderIDs?: Array<string>, mediaIDs?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MediaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async dropEmbeddings(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.dropEmbeddings(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MediaApi.dropEmbeddings']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getMedia(shareID?: string, raw?: boolean, hidden?: boolean, sort?: GetMediaSortEnum, sortDirection?: GetMediaSortDirectionEnum, search?: string, page?: number, limit?: number, folderIDs?: Array<string>, mediaIDs?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MediaBatchInfo>> {
...
export class MediaApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public dropEmbeddings(options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public getMedia(shareID?: string, raw?: boolean, hidden?: boolean, sort?: GetMediaSortEnum, sortDirection?: GetMediaSortDirectionEnum, search?: string, page?: number, limit?: number, folderIDs?: Array<string>, mediaIDs?: Array<string>, options?: RawAxiosRequestConfig) {
...
export const GetMediaSortDirectionEnum = {
    NUMBER_1: 1,
    NUMBER_MINUS_1: -1
} as const;
export type GetMediaSortDirectionEnum = typeof GetMediaSortDirectionEnum[keyof typeof GetMediaSortDirectionEnum];
...
export const TowersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRunningTasks: async (includeExited?: boolean, since?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const TowersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRunningTasks(includeExited?: boolean, since?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TaskInfo>>> {
...
export class TowersApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getRunningTasks(includeExited?: boolean, since?: number, options?: RawAxiosRequestConfig) {
