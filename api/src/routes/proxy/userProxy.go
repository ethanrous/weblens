...
func (p *ProxyStore) UpdatePsaswordByUsername(username types.Username, newPasswordHash string) error {
	return types.ErrNotImplemented("UpdatePsaswordByUsername proxy")
}
